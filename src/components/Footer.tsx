...
const Footer = () => {
  ...
  return (
    <footer className="bg-yellow-100 border-t border-border py-12 px-4">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 bg-yellow rounded-full flex items-center justify-center hover:bg-yellow-dark transition-colors" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-black hover:text-gold transition-colors">{t("footer.quickLinks.home")}</a></li>
              <li><a href="/menu" className="text-black hover:text-gold transition-colors">{t("footer.quickLinks.menu")}</a></li>
              <li><a href="#contact" className="text-black hover:text-gold transition-colors">{t("footer.quickLinks.contact")}</a></li>
              <li><a href="#" className="text-black hover:text-gold transition-colors">{t("footer.quickLinks.offers")}</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-2">
              <span className="px-3 py-1 bg-yellow text-black text-xs font-medium rounded-full">JustEat</span>
